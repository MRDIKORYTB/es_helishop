...
local helishop = {
	...
	menu = {
		...
		["Hélicoptères"] = {
			...
			name = "Hélicoptères",
			buttons = {
				{name = "Super Volito", costs = 1500000, description = {}, model = "supervolito"},
                                {name = "Super Volito 2", costs = 1500000, description = {}, model = "supervolito2"},
                                {name = "Volatus", costs = 4000000, description = {}, model = "volatus"},
                                {name = "Swift", costs = 4200000, description = {}, model = "swift"},
                                {name = "Swift 2", costs = 4200000, description = {}, model = "swift2"},
			}
		},
	}
}
